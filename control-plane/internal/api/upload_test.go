...
func TestUploadHandler(t *testing.T) {
	...
	router := api.NewRouter(nil, runs, nil, nil, arts, nil, nil, nil, nil, time.Minute, "", discardLogger())
	...
	smallRouter := api.NewRouter(nil, runs, nil, nil, arts, nil, nil, nil, nil, time.Minute, "", discardLogger())
	...
	// 5) 存储未配置 → 503。
	nilRouter := api.NewRouter(nil, runs, nil, nil, nil, nil, nil, nil, nil, time.Minute, "", discardLogger())
