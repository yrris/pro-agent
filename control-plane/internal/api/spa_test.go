...
func TestSPAHandler(t *testing.T) {
	...
	router := api.NewRouter(nil, nil, nil, nil, nil, nil, nil, nil, nil, time.Minute, webDir, discardLogger())
	...
	bare := api.NewRouter(nil, nil, nil, nil, nil, nil, nil, nil, nil, time.Minute, "", discardLogger())
